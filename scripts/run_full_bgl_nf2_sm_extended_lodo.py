"""Run the production BGL nf=2 SM extended all-dataset LODO analysis."""
...
def main() -> None:
    analysis.ANALYSIS_NAME = "BGL_nf2_SM_extended"
    ...
    print(f"Full BGL nf=2 SM extended LODO metadata: {metadata}")
